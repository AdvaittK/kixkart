    ...
    >
      <div className="flex flex-col gap-8">
        ...
        <motion.div variants={itemVariants} className="flex flex-col gap-4">
          <h1 className="text-4xl font-bold tracking-tight cyberpunk-text">Sneakers</h1>
          <p className="text-muted-foreground">
            Discover our collection of premium sneakers from top brands. Find the perfect pair for your style.
          </p>
        </motion.div>
