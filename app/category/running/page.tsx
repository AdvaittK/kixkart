...
const brands = ["Nike", "Adidas", "New Balance", "Brooks", "Asics", "Saucony", "Hoka"]
    ...
    >
      <div className="flex flex-col gap-8">
        ...
        <motion.div variants={itemVariants} className="flex flex-col gap-4">
          <h1 className="text-4xl font-bold tracking-tight cyberpunk-text">Running</h1>
          <p className="text-muted-foreground">
            Discover our collection of premium running shoes designed for performance and comfort. Find the perfect pair for your runs.
          </p>
        </motion.div>
